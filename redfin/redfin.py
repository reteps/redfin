...
class Redfin:
    ...
    def meta_property(self, url, kwargs, page=False):
        ...
        return self.meta_request(
            "api/home/details/" + url, {"accessLevel": 3, **kwargs}
        )
    ...
    def initial_info(self, url, **kwargs):
        return self.meta_request(
            "api/home/details/initialInfo", {"path": url, **kwargs}
        )

    def page_tags(self, url, **kwargs):
        return self.meta_request(
            "api/home/details/v1/pagetagsinfo", {"path": url, **kwargs}
        )

    def primary_region(self, url, **kwargs):
        return self.meta_request(
            "api/home/details/primaryRegionInfo", {"path": url, **kwargs}
        )

    # Search
    def search(self, query, **kwargs):
        return self.meta_request(
            "do/location-autocomplete", {"location": query, "v": 2, **kwargs}
        )

    # Property ID Requests
    def below_the_fold(self, property_id, **kwargs):
        return self.meta_property(
            "belowTheFold", {"propertyId": property_id, **kwargs}, page=True
        )
    ...
    def page_header(self, property_id, **kwargs):
        return self.meta_request(
            "api/home/details/homeDetailsPageHeaderInfo",
            {"propertyId": property_id, **kwargs},
        )

    def property_comments(self, property_id, **kwargs):
        return self.meta_request(
            "api/v1/home/details/propertyCommentsInfo",
            {"propertyId": property_id, **kwargs},
        )
    ...
    def claimed_home_seller_data(self, property_id, **kwargs):
        return self.meta_request(
            "api/home/details/claimedHomeSellerData",
            {"propertyId": property_id, **kwargs},
        )
    ...
    def neighborhood_stats(self, property_id, **kwargs):
        return self.meta_request(
            ...
            {"propertyId": property_id, "accessLevel": 3, **kwargs},
        )
    ...
    def similar_listings(self, property_id, listing_id, **kwargs):
        return self.meta_property(
            "similars/listings",
            {"propertyId": property_id, "listingId": listing_id, **kwargs},
        )
    ...
    def customer_conversion_info_off_market(self, property_id, listing_id, **kwargs):
        return self.meta_property(
            "customerConversionInfo/offMarket",
            {"propertyId": property_id, "listingId": listing_id, **kwargs},
            page=True,
        )
